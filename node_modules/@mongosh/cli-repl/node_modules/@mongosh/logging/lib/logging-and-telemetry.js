...
class LoggingAndTelemetry {
    ...
    setupBusEventListeners() {
        ...
        const getTelemetryUserIdentity = () => {
            return {
                anonymousId: this.busEventState.telemetryAnonymousId ??
                    this.busEventState.userId,
            };
        };
        const track = (message) => {
        ...
        onBus('mongosh:update-user', (updatedTelemetryUserIdentity) => {
            ...
            identify();
            this.log.info('MONGOSH', (0, mongodb_log_writer_2.mongoLogId)(1_000_000_005), 'config', 'User updated');
        });
